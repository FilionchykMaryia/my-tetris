...
// import { tetroBuff } from './../tetrominos';
...
const Tetris = () => {
  ...
  //const [miniStage, setMiniStage, tetroForDisplay] = useMiniStage(player);
...
//<DisplayForNextTetro text={`Next: `} miniStage={miniStage} tetroForDisplay={tetroForDisplay}/>